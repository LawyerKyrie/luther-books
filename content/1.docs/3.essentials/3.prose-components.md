...
---
  :::accordion
    ...
    ---
    Nuxt UI is now compatible with Vue! You can follow the [installation guide](/docs/getting-started) to get started.
    ::::
  :::
...
::code-preview
  :::card-group{.w-full}
    ...
    ---
    A template with landing, find, docs and blog.
    ::::
